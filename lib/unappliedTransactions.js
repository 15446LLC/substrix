...
function parseAgingOverpayments(report, nameColKey) {
...
async function buildUnappliedTransactionsHealth(session) {
  ...
  const customerOverpayments = parseAgingOverpayments(arAging, 'cust_name');
  ...
  const overpayments = parseAgingOverpayments(apAging, 'vend_name');
